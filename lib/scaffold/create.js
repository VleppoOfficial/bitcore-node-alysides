...
var BASE_PACKAGE = {
  description: 'A full Alysides node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-alysides': 'git+https://git@github.com/VleppoOfficial/bitcore-lib-alysides',
    'bitcore-node-alysides': 'git+https://git@github.com/VleppoOfficial/bitcore-node-alysides'
  }
};
